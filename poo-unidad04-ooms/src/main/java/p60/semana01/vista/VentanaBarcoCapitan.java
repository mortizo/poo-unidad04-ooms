...
import p60.semana01.vista.barco.CreateBarco;
import p60.semana01.vista.barco.DeleteBarco;
import p60.semana01.vista.barco.UpdateBarco;
import p60.semana01.vista.capitan.CreateCapitan;

/**
 *
 * @author morti
 */
public class VentanaBarcoCapitan extends javax.swing.JFrame {

    /**
     * Creates new form VentanaBarcoCapitan
     */
    public VentanaBarcoCapitan() {
        initComponents();
    }
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        ...
        var createBarco = new CreateBarco();
        createBarco.setIconifiable(true);
        createBarco.setClosable(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaBarcoCapitan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaBarcoCapitan().setVisible(true);
            }
        });
    }
